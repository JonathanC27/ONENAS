...
book; 10 seeds per width, 6 at 16 islands). Left: pooled net return (mean
$\pm$ SE). Right: Sharpe --- mean with $\pm$1 seed-SD band, and the worst
seed; width narrows the seed distribution (SD 0.171 $\to$ 0.078, worst
seed 0.41 $\to$ 0.78) more than it moves the mean.}
\label{fig:islands}
\end{figure}
