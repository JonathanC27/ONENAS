...
\item[b] Prior paper's conditional book applied verbatim; trigger fires
daily on rank-normal predictions.
\item[c] Published ONE-NAS prediction rule; seeds 42--44 ($n{=}3$).
\item[d] Prior paper's published Table 7 cells; 2022--24 column is their
sum.
\end{tablenotes}
\end{threeparttable}
\end{table}
...
Equal-weight buy \& hold & $+0.66$ & $+1.7$ & $+0.41$ & $+0.969$ \\
\bottomrule
\end{tabular}
\end{table}
